...
class CodeSigningManager
  ...
  def match_development(update: false)
    @fastlane.match(
      type: 'development',
      app_identifier: [@bundle_id_production, @bundle_id_uat],
      keychain_name: @keychain_name,
      keychain_password: @keychain_password,
  ...
  def match_adhoc(update: false)
    @fastlane.match(
      type: 'adhoc',
      app_identifier: [@bundle_id_sit, @bundle_id_uat],
      keychain_name: @keychain_name,
      keychain_password: @keychain_password,
      force_for_new_devices: update,
      force: update,
  ...
  def match_appstore(update: false)
    @fastlane.match(
      type: 'appstore',
      app_identifier: [@bundle_id_uat, @bundle_id_production],
      keychain_name: @keychain_name,
      keychain_password: @keychain_password,
      force_for_new_devices: update,
      force: update,
